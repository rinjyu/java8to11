...
public class Stream2 {
    ...
    public static void main(String[] args) {
        ...
        List<List<OnlineClass>> rinjyuEvents = new ArrayList<>();
        rinjyuEvents.add(springClasses);
        rinjyuEvents.add(javaClasses);
        ...
        boolean test = javaClasses.stream().allMatch(c -> c.getTitle().contains("Test"));
        ...
        List<String> strings = springClasses.stream()
                .map(OnlineClass::getTitle)
